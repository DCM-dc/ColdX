...
export async function ensureProfile({ home, dshRoot, projectRoot, persona }) {
  ...
  const patch = [
    ...
    { insert: [{id:'coldx-kernel',name:kernelEntry}, {id:'coldx-superpowers',name:superpowersEntry,config:{home,profileDir}}, {id:'coldx-usage',name:usageEntry,config:{profileDir}}, {id:'coldx-updates',name:updatesEntry,config:{profileDir}}] },
  ];
